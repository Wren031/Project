...
class InquirePage(AppPage):
    ...
    def invalid_keyword(self):
        self.dlg = ft.AlertDialog(
                open=True,
                title=ft.Text('Not Available!!',size=25,weight='bold',color='red900')
            )
        ...
        self.dlg = ft.AlertDialog(
                ...
                content=ft.Container(
                    content=ft.Column(
                        ...
                        width=350,height=450,controls=[
                        avail_recipt_transaction,
                        avail_recipt_information,
                        ft.Divider(),
                        ft.Text(''),
                        ft.Text('       Thank You',size=25,weight='bold',color='green'),
                    ])
                )
            )
        self.root.dialog = self.dlg
    ...
    def __init__(self, root, route):
        ...
        self.appbar = ft.AppBar(
            leading_width=40,
            title=ft.Text("BOOK THE BEST CAR FOR YOU",size=23,weight='bold',color='black'),
            center_title=False,
        ...
        textcontainer = ft.Container(
            ...
            content=ft.Container(
                ft.Column([
                    ...
                    ft.Text('   ON THE ROAD',size=45,weight='bold',color='white')
                ])
            )
        )
        ...
        ft.Column([
            ft.Container(
                ...
                content=ft.Stack([
                        ft.Image(
                            src="Pics/636320110675597097-Enterprise-1.webp",
                            fit='cover',
                            height=200,
                            width=1300,
                        ),myimagecontainer
            ...
            self.dlg = ft.AlertDialog(
                ...
                content=ft.Container(
                    ...
                    content=ft.Column(
                        ...
                        controls=[
                            ft.Column([
                                ft.Text(f'{item.car_model}    P {item.price}', size=23),
                                ft.Divider(),
                                ft.Row([
                                ft.TextField(label='Driver Licensed ID ', ref=self.transaction_driver, width=250, height=35),
                                ft.TextField(label='Destination', ref=self.transaction_location, width=250, height=35),
                                    ]),
                                ft.Row([
                                ft.TextField(label='Address', ref=self.transaction_address, width=250, height=35),
                                ft.TextField(label='Birthday DD-MM-YY', ref=self.transaction_age, width=250, height=35),   
                                    ]),
                                ft.Row([
                                ft.TextField(label='Duration Days', ref=self.transaction_days, width=250, height=35),
                                ft.TextField(label='Name', ref=self.transaction_name, width=250, height=35),
                                    ]),
                                ft.Row([
                                ft.TextField(label='Contact Number ', ref=self.transaction_number, width=250, height=35),
                                 ft.Row([self.transaction_status]),
                                    ]),
                                ft.Column([
                                ft.TextField(label='Start date DD-MM-YY',ref=self.transaction_start,width=250,height=32),
                                ft.TextField(label='End date DD-MM-YY',ref=self.transaction_end,width=250,height=35)
                                    ]),
                            ]),
                        ]
                    ),
                ...
                actions=[
                    ft.FilledButton('Avail Now', on_click=lambda _:self.avail_transaction(i=item), width=250),
                ],
                actions_alignment=ft.MainAxisAlignment.END,
            )
            avail_recipt_transaction.controls.append(
                ft.Container(ft.Column(controls=[
                    ft.Text(f'               Date: {item.created}',size=15,weight='bold'),
                    ft.Divider(),
            ...
            ft.Container(
                ...
                content=ft.Column(controls=[
                    ...
                    content=ft.Row([
                            ...
                            ft.Text(f'{i.status}',size=20)
                        ]),
                            ft.Row([
                                ft.IconButton(icon=ft.icons.LOCAL_GAS_STATION),
    ...
    def product_ui(self, i: Cars) -> ft.Container:
